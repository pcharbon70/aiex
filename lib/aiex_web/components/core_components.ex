defmodule AiexWeb.CoreComponents do
  @moduledoc """
  Provides core UI components for Aiex.
  ...
  ## Examples
      ...
      <.header>
        Listing Users
        <:subtitle>Manage users in your organization</:subtitle>
      </.header>
  """
  attr :class, :string, default: nil
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AiexWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AiexWeb.Gettext, "errors", msg, opts)
    end
  end

defmodule Aiex.LLM.Templates.PromptTemplate do
  ...
  defp code_explanation_template do
    new("code_explanation", 
      ...
      """,
      system_prompt: "You are an expert software engineer helping to explain code clearly and comprehensively.",
  ...
  defp code_generation_template do
    new("code_generation",
      ...
      """,
      system_prompt: "You are an expert {{language}} developer. Write clean, efficient, and well-documented code.",
  ...
  defp test_generation_template do
    new("test_generation",
      ...
      """,
      system_prompt: "You are an expert in test-driven development and {{language}} testing frameworks.",
  ...
  defp refactoring_template do
    new("refactoring",
      ...
      """,
      system_prompt: "You are an expert software engineer specializing in code refactoring and clean code principles.",

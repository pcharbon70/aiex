defmodule Aiex.LLM.RateLimiter do
  ...
  defp load_rate_limits do
    %{
      ...
      ollama: %{
        # No limits for local
        requests_per_minute: get_env_int("AIEX_OLLAMA_RPM", nil),
        tokens_per_minute: get_env_int("AIEX_OLLAMA_TPM", nil)
      },
      lm_studio: %{
        # No limits for local
        requests_per_minute: get_env_int("AIEX_LM_STUDIO_RPM", nil),
        tokens_per_minute: get_env_int("AIEX_LM_STUDIO_TPM", nil)
      },
      google: %{

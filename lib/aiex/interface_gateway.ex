defmodule Aiex.InterfaceGateway do
  ...
  defp cleanup_interface_resources(interface_id, state) do
    ...
    new_active_sessions =
      Map.reject(state.active_sessions, fn {_session_id, session_info} ->
    ...
    new_request_registry =
      Map.reject(state.request_registry, fn {_request_id, request_info} ->
